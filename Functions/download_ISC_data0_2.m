function [Primes, Hypocentres, Magnitudes, Phases, FocalMechanisms] = download_ISC_data0_2( ...
    ...
    while t_stop < 1
        ...
        if request == "GLOBAL"
            ...
            [Primes, Hypocentres, Magnitudes, Phases, FocalMechanisms] = readISCData(...
                text_data, Primes, Hypocentres, Magnitudes, Phases, FocalMechanisms, ...
        ...
        if request == "POLYGON"
            ...
            [Primes, Hypocentres, Magnitudes, Phases, FocalMechanisms] = readISCData(text_data, ...
