function [uz_out, trend_out, plunge_out] = focalmech(fm, centerX, ...
    centerY, diam, varargin)
...
% 
%   5/12/2024 Minor modification by Tom Garth, International Siesmological 
%   Centre, UK to output 'z' 'trend' and 'plunge' for use in 3D moment 
%   tensor plotting
